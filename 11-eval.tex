...
\begin{figure}[ht]
	...
	\end{subfigure}
	\caption{Repeatability area score \textbf{$\areascore$ of the \meshset dataset.} Repeatability area scores under varying (a) rotation, from $0$ to $90$ degree; (b) scaling factor, from $0.5$ to $2$ in log scale.}
...
\begin{figure}[ht]
	...
	\caption{\textbf{Repeatability area scores $\areascore$ of the \meshset dataset.} Repeatability area score under varying percentage of interest points. }
