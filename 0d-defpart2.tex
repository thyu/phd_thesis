...
\newcommand{\cuboidset}{\mathcal{P}}
\newcommand{\actionset}{\mathcal{A}} 
\newcommand{\vpatch}{\mathbf{p}}
\newcommand{\codebooksize}{L}
\newcommand{\vfastset}{\mathcal{U}} 
\newcommand{\vfastsetx}{\mathcal{\hat{U}}} 
\newcommand{\onevfast}{u} 
\newcommand{\histogram}{\mathbf{H}} 
\newcommand{\histogramx}{\mathbf{H}} 
\newcommand{\bost}{\mathbf{B}} 
\newcommand{\vcode}{l}
\newcommand{\kernel}{\Psi}
\newcommand{\resolute}{q}
\newcommand{\bcir}{\mathcal{B}}
...
\newcommand{\bodyposead}{\boldsymbol{\alpha}}
\newcommand{\bodyposepr}{\boldsymbol{\beta}}
\newcommand{\bodyposez}{\boldsymbol{\gamma}}
...
\newcommand{\qualitycmjr}{\mathrm{H_{r}}} 
\newcommand{\nclass}{C}
\newcommand{\pcadim}{6}
