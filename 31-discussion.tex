...
A hybrid framework for 3D pose estimation is a potential search direction in the future. There exist various approaches to combine an appearance-based algorithm with a model-based algorithm.  
